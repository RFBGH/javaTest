...
//        }
        ...
        isValidBST.TreeNode root = new isValidBST.TreeNode(5);
        root.setLeft(new isValidBST.TreeNode(1));
        root.setRight(new isValidBST.TreeNode(4));
        root.getRight().setLeft(new isValidBST.TreeNode(3));
        root.getRight().setRight(new isValidBST.TreeNode(6));
